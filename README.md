...
torch
Usage
Place the training and test data in the data folder
Run the Jupyter notebook notebooks/Last working.ipynb
The predictions will be saved in output/submission.csv
Model Description
